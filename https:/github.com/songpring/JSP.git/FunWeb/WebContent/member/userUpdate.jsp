...
<article>
<h1>회원정보수정</h1>
<form action="userUpdatePro.jsp" id="join" method="post" name="fr" onsubmit="return fincheck()" >
<fieldset>
<legend>회원정보</legend>
<label>이름</label>
<input type="text" name="name"  value="<%=bb.getName() %>" disabled="disabled"><span id="su">_수정불가</span><br>
<label>아이디</label>
<input type="text" name="id" class="id" value="<%=bb.getId() %>" disabled="disabled"><span id="su">_수정불가</span><br>
<label>패스워드</label>
<input type="password" name="pass" value=<%=bb.getPass() %>><br>
...
<label>우편번호</label>
<input type="text" id="post" name="post" placeholder="우편번호" value="<%=post %>">
<input type="button" value="우편번호검색" class="dup" onclick="sample4_execDaumPostcode()"><br>
<label>도로명주소</label><input type="text" name="address1" id="address1" value="<%=address%>">
<br>
<label>상세주소</label>
<input type="text" id="sample4_detailAddress" name="address2" placeholder="건물명, 동, 호수"
 value="<%=address2%>"><br>

<label>전화번호</label>
<input type="text" name="phone" value="<%=phone%>" placeholder="ex) 051-322-4477"><br>
<label>휴대폰번호</label>
<input type="text" name="mobile"  value="<%=mobile%>" placeholder="ex) 010-3222-4477"><br>
</fieldset>
<script type="text/javascript">
function fincheck(){
