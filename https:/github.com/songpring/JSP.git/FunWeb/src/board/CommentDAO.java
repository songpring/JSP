...
public class CommentDAO {
	...
	public void insertComment(CommentBean cb) {
		...
		try {
			con = getConnection();
			String sql = "insert into comment(idx,content,parent_num,id,date) values(null,?,?,?,?)";
	...
	public List<CommentBean> getCommentList(int parent_num) {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
...
//			 String sql="select * from board order by num desc";
			String sql = "select * from comment where parent_num =?";
			pstmt = con.prepareStatement(sql);
